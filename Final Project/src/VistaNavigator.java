...
public class VistaNavigator {
    ...
    public static final String VISTA = "view/vista.fxml";
    public static final String TIP_CALCULATOR = "view/tipCalculator.fxml";
    public static final String CUSTOMERS = "view/customers.fxml";
    public static final String TRANSACTION = "view/transaction.fxml";
    public static final String WELCOME = "view/welcome.fxml";
    public static final String TRANSACTIONS = "view/transactions.fxml"; 
    public static final String PRODUCTS = "view/products.fxml"; 
